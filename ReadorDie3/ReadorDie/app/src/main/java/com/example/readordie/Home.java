...
public class Home extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    private void loadMenu() {
        ...
        categoryBuilder.setQuery(Category.class, menu_item, MenuViewHolder.class, databaseReference);
        FirebaseRecyclerOptions<Category> options = categoryBuilder.build();

        FirebaseRecyclerAdapter<Category, MenuViewHolder> adapter = new FirebaseRecyclerAdapter<Category, MenuViewHolder>(databaseReference) {
            @Override
